...
<head>
    ...
    @php
        ...
        elseif (Route::is('frontend.faq')) { $metaTitle = 'Rudraksha, Gemstones, Orders & Shipping — All Answers'; $metaDesc = 'Rudraksha kaise pehnen? Stone authentic hai kya? Answers yahan hain.'; $metaKeys = 'suyagya faq, spiritual jewelry faq India'; }
    ...
    {{-- ⚡ SPEED OPTIMIZATION STEP 2: PRELOAD CRITICAL CSS ASSETS TO ELIMINATE CHAINING --}}
    ...
    {{-- Non-critical CSS फ़ाइलों को नॉन-ब्लॉकिंग (Asynchronous) लोड करें --}}
