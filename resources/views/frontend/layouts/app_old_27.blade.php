...
<head>
    ...
    @php
        ...
        elseif (Route::is('terms.conditions')) {
            ...
            $metaTitle = 'Rudraksha, Gemstones, Orders & Shipping — All Answers';
            $metaDesc = 'Rudraksha kaise pehnen? Stone authentic hai kya? Order track karna hai? Shipping kitne din mein? Sab answers yahan hain — abhi padho.';
            $metaKeys = 'suyagya faq, rudraksha kaise pehne, gemstone bracelet questions, original rudraksha kaise pahchane, suyagya shipping, suyagya return policy, spiritual jewelry faq India';
...
<body>
        ...
        <div id="chat-content"
            ...
            <div id="chat-messages-container">
                <div class="bot-msg"
                    ...
                    Namaste! 🙏 Main aapka digital jyotish hoon. Apni kundali ke anusar sahi upay janne ke liye details
                    bharein:
                </div>
            ...
            <div id="astro-form">
                ...
                <div class="mb-2 position-relative">
                    ...
                    <input type="text" id="birth_city" class="form-control"
                        placeholder="Type your city (e.g. New Delhi)" oninput="searchCity(this.value)"
                        autocomplete="off">
                ...
                <button onclick="processAstroRequest()" id="submit-btn" class="btn btn-primary w-100"
                    style="background:#673ab7; border:none; height: 45px; font-weight: bold;">
    ...
    {{-- ✅ 2. Google Tag Manager (noscript) - <body> के तुरंत बाद --}}
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MLSST65C"
