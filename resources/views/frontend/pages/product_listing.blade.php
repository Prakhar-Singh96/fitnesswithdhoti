        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                @if ($products->count() > 0)
                        ...
                        @foreach ($products as $product)
                            <div class="col-6 col-md-4">
                                <div class="product-card h-100 position-relative">
                                    ...
                                    {{-- 🖼️ Image Box with Video Overlay --}}
                                    <div class="img-box mb-3 position-relative overflow-hidden rounded-0">
                                        ...
                                        <button type="button"
                                            ...
                                            style="width: 35px; height: 35px; display: flex; align-items: center; justify-content: center; z-index: 4;">
                                        ...
                                        {{-- 🎥 Video Play Button Overlay (Bottom-Right Corner) --}}
                                        @if ($product->youtube_link)
                                            <div class="video-overlay-icon position-absolute bottom-0 end-0 m-2"
                                                ...
                                                <a href="javascript:void(0);" data-bs-toggle="modal"
                                                    ...
                                                    style="background: rgba(220, 53, 69, 0.9); width: 38px; height: 38px; border-radius: 50%; border: 2px solid #fff;">
                                                    <i class="las la-play" style="font-size: 18px;"></i>
                                                </a>
                                            </div>

                                            {{-- Video Modal (Shorts Optimized) --}}
                                    ...
                                    {{-- 📝 Product Info (Rating Only, No Video Button here) --}}
                                    <div class="product-info text-left">
                                        ...
                                        <div class="d-flex align-items-center mb-1">
                                            <div class="text-warning d-flex align-items-center" style="font-size: 13px;">
                                                @php
                                                ...
                                                @for ($i = 1; $i <= 5; $i++)
                                                    ...
                                                    @endif
                                                @endfor
                                                <span class="text-muted ms-1 text-dark fw-bold"
                    ...
                    <div class="mt-5 d-flex justify-content-center">{{ $products->links('pagination::bootstrap-5') }}
                    </div>
                @else
    ...
    <style>
        ...
        @media (max-width: 991px) {
            .subcategory-nav-container {
                padding: 5px 0;
                margin: 0 -15px;
                /* कंटेनर के बाहर तक स्क्रॉल करने के लिए */
                padding-left: 15px;
                /* पहली चिप को गैप देने के लिए */
            }
        }
