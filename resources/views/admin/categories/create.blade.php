                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                       id="name" name="name" placeholder="Ex: Electronics" value="{{ old('name') }}" required />
                                @error('name') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                            <div class="col-md-6">
                                <label class="form-label" for="slug">Slug <span class="text-danger">*</span></label>
                                <input type="text" class="form-control @error('slug') is-invalid @enderror"
                                       id="slug" name="slug" placeholder="Ex: electronics" value="{{ old('slug') }}" readonly />
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="meta_description" name="meta_description" rows="3" placeholder="SEO Description">{{ old('meta_description') }}</textarea>
                        </div>
                        <div class="mb-3">
                 ...
                 <div class="card mb-4">
                    ...
                    <div class="card-body">
                         <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="og_title" name="og_title" value="{{ old('og_title') }}" placeholder="Social Share Title">
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="og_description">OG Description</label>
                            <textarea class="form-control" id="og_description" name="og_description" rows="2" placeholder="Social Share Description">{{ old('og_description') }}</textarea>
                        </div>
                        <div class="mb-3">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <input class="form-control mb-2" type="file" id="icon_image" name="icon_image" accept="image/*">
                            <input type="text" class="form-control form-control-sm" name="icon_alt" placeholder="Icon Alt Text (SEO)" value="{{ old('icon_alt') }}">
                        </div>

                        {{-- Cover Image --}}
                        <div class="mb-4">
                            <label for="cover_image" class="form-label fw-bold">Cover Image</label>
                            <input class="form-control mb-2" type="file" id="cover_image" name="cover_image" accept="image/*">
                            <input type="text" class="form-control form-control-sm" name="cover_alt" placeholder="Cover Alt Text (SEO)" value="{{ old('cover_alt') }}">
                        </div>

                        {{-- Banner Image --}}
                        <div class="mb-3">
                            <label for="banner_image" class="form-label fw-bold">Banner Image</label>
                            <input class="form-control mb-2" type="file" id="banner_image" name="banner_image" accept="image/*">
                            <input type="text" class="form-control form-control-sm" name="banner_alt" placeholder="Banner Alt Text (SEO)" value="{{ old('banner_alt') }}">
                        </div>
