                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="meta_keywords" value="{{ old('meta_keywords', $category->meta_keywords) }}" placeholder="keyword1, keyword2">
                        </div>
                    </div>
                </div>
                 ...
                 <div class="card mb-4">
                    ...
                    <div class="card-body">
                         <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="og_title" value="{{ old('og_title', $category->og_title) }}">
                        </div>
                        <div class="mb-3">
            ...
            <div class="col-xl-4 col-lg-5">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="status" id="status_inactive" value="0" {{ $category->status == 0 ? 'checked' : '' }}>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control form-control-sm mb-2" name="icon_alt" placeholder="Icon Alt Text" value="{{ old('icon_alt', $category->icon_alt) }}">

                            @if($category->icon_image)
                                <img src="{{ asset($category->icon_image) }}" alt="Icon" class="rounded border p-1" width="60">
                            @endif
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control form-control-sm mb-2" name="cover_alt" placeholder="Cover Alt Text" value="{{ old('cover_alt', $category->cover_alt) }}">

                            @if($category->cover_image)
                                <img src="{{ asset($category->cover_image) }}" alt="Cover" class="rounded border p-1 w-100" style="max-height: 100px; object-fit: cover;">
                            @endif
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control form-control-sm mb-2" name="banner_alt" placeholder="Banner Alt Text" value="{{ old('banner_alt', $category->banner_alt) }}">

                            @if($category->banner_image)
                                <img src="{{ asset($category->banner_image) }}" alt="Banner" class="rounded border p-1 w-100" style="max-height: 80px; object-fit: cover;">
                            @endif
                        </div>
