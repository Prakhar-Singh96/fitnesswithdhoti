    ...
    <div class="card-body">
        ...
        <form action="{{ route('admin.videos.update', $video->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="url" name="link" class="form-control" value="{{ old('link', $video->link) }}" required>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    @if($video->image)
                        <div class="mt-3 p-2 border rounded bg-light">
                            ...
                            <img src="{{ asset($video->image) }}" alt="Poster" class="img-thumbnail" style="width: 120px; height: 120px; object-fit: cover;">
                        </div>
                    @endif
                </div>
            </div>
