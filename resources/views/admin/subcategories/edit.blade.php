                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="slug" name="slug" value="{{ old('slug', $subCategory->slug) }}" readonly>
                            </div>
                        </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="meta_keywords" value="{{ old('meta_keywords', $subCategory->meta_keywords) }}">
                        </div>
                    </div>
                </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="og_title" value="{{ old('og_title', $subCategory->og_title) }}">
                        </div>
                        <div class="mb-3">
