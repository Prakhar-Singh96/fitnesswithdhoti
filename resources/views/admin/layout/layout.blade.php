...
<html
  ...
  <head>
    ...
    <link rel="stylesheet" href="{{ url('admin/assets/vendor/libs/pickr/pickr-themes.css') }}" />
  ...
  <body>
    ...
    <script src="{{ url('admin/assets/vendor/libs/@algolia/autocomplete-js.js') }}"></script>

    <script src="{{ url('admin/assets/vendor/libs/pickr/pickr.js') }}"></script>
